...
## [v2.0.0](https://github.com/axlon/laravel-postal-code-validation/tree/v2.0.0) (2019-06-09)
...
- Added support for referencing request array parameters (e.g. `addresses.*.country`)
- Added support for referencing request variables whilst using a custom validator class
